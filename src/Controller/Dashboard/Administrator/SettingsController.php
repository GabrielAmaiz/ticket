...
class SettingsController extends Controller {
    ...
    public function payment(Request $request, AppServices $services, TranslatorInterface $translator) {
        ...
        $form = $this->createFormBuilder()
                ...
                ->add('organizer_payout_mercadopago_enabled', ChoiceType::class, [
                    'required' => true,
                    'multiple' => false,
                    'expanded' => true,
                    'label' => 'Allow Mercado Pago as a payout method for the organizers to receive their revenue',
                    'choices' => ['Yes' => 'yes', 'No' => 'no'],
                    'label_attr' => ['class' => 'radio-custom radio-inline'],
                    'constraints' => array(
                        new NotNull()
        ...
        if ($form->isSubmitted()) {
            if ($form->isValid()) {
                ...
                $services->setSetting("organizer_payout_mercadopago_enabled", $settings['organizer_payout_mercadopago_enabled']);
            ...
            $form->get('organizer_payout_mercadopago_enabled')->setData($services->getSetting("organizer_payout_mercadopago_enabled"));
    ...
    public function homepagehero(Request $request, AppServices $services, TranslatorInterface $translator) {
        ...
        if ($form->isSubmitted()) {
            if ($form->isValid()) {
                ...
                $services->setSetting("customTextHome1", $settings['customTextHome1']);
                $services->setSetting("customSubTextHome1", $settings['customSubTextHome1']);
                $services->setSetting("customTextHome2", $settings['customTextHome2']);
                $services->setSetting("customSubTextHome2", $settings['customSubTextHome2']);
                $services->setSetting("customTextHome3", $settings['customTextHome3']);
                $services->setSetting("customSubTextHome3", $settings['customSubTextHome3']);
            ...
            $form->get('customTextHome1')->setData($services->getSetting("customTextHome1"));
            $form->get('customSubTextHome1')->setData($services->getSetting("customSubTextHome1"));
            $form->get('customTextHome2')->setData($services->getSetting("customTextHome2"));
            $form->get('customSubTextHome2')->setData($services->getSetting("customSubTextHome2"));
            $form->get('customTextHome3')->setData($services->getSetting("customTextHome3"));
            $form->get('customSubTextHome3')->setData($services->getSetting("customSubTextHome3"));
        }
