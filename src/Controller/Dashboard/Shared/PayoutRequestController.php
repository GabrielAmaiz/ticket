...
class PayoutRequestController extends Controller {
    ...
    public function approve($reference, Request $request, TranslatorInterface $translator, AppServices $services) {
        ...
        if ($payoutRequest->getPaymentGateway()->getFactoryName() == "paypal_rest") {
        ...
        } else if ($payoutRequest->getPaymentGateway()->getFactoryName() == "mercadopago_checkout") {
            // Agrega credenciales
            ...
            $preference->back_urls = array(
                "success" => "https://0aef-181-44-3-223.ngrok-free.app/vincular/vendedor",
                "failure" => "https://0aef-181-44-3-223.ngrok-free.app/vincular/error",
                "pending" => "https://0aef-181-44-3-223.ngrok-free.app/vincular/error"
            );
            ...
            $preference->external_reference = 234;
            $preference->binary_mode = true;
    
            // Opcional para setear las url del webhook
            $preference->notification_url = 'https://0aef-181-44-3-223.ngrok-free.app/vincular/notificacion';
            ...
            $payer->email = "gabriel.amaizp@hotmail.com";
            ...
            return $this->render(
                'Dashboard/Shared/Payout/mp.html.twig',array(
                    //'url' => "https://www.mercadopago.com.ar/checkout/v1/modal/?preference-id=" . $preference->id
                    'preferenceId' => $preference->id
                )
            );
            */
            die("Die del controlador PayouRequestController.");
            dump($payoutRequest);die;
                /*
                MercadoPagoConfig::setAccessToken($payoutRequest->getPaymentGateway()->getConfig()['secret_key']);
                */

                //$secret_key = $payoutRequest->getPaymentGateway()->getConfig()['secret_key'];
