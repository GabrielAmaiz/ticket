...
class PaymentGatewayRepository extends ServiceEntityRepository {
    ...
    public function getPaymentGateways($organizer, $enabled, $gatewayFactoryName, $slug, $sort, $order, $organizerPayoutPaypalEnabled, $organizerPayoutStripeEnabled, $organizerPayoutMercadopagoEnabled) {
        ...
        if ($organizer !== null) {
            ...
            if ($organizerPayoutMercadopagoEnabled == "no") {
                $qb->andWhere("p.gatewayName != 'mercadopago_checkout'");
            }
        } else {
