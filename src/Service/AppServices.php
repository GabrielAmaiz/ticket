...
class AppServices {
    ...
    public function getPaymentGateways($criterias) {
        ...
        $organizerPayoutMercadopagoEnabled = $this->getSetting("organizer_payout_mercadopago_enabled");

        return $this->em->getRepository("App\Entity\PaymentGateway")->getPaymentGateways($organizer, $enabled, $gatewayFactoryName, $slug, $sort, $order, $organizerPayoutPaypalEnabled, $organizerPayoutStripeEnabled, $organizerPayoutMercadopagoEnabled);
    }
